---
title: License
description: Licensed under the Apache License, Version 2.0 (the "License"); you may not use any files from the Chorale project except in compliance with the License. You can obtain a copy of the License here.
type: wrapped
---
